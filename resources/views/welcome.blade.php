                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="offers_image_container">
                                    ...
                                    <div class="offers_image_background" style="background-image:url({{asset('asset/images/offer_1.jpg')}})">
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="offers_image_container">
                                    ...
                                    <div class="offers_image_background" style="background-image:url({{asset('asset/images/offer_2.jpg')}})">
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="offers_image_container">
                                    ...
                                    <div class="offers_image_background" style="background-image:url({{asset('asset/images/offer_3.jpg')}})">
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="offers_image_container">
                                    ...
                                    <div class="offers_image_background" style="background-image:url({{asset('asset/images/offer_4.jpg')}})">
                                    </div>
                ...
                <div class="col">
                    ...
                    <div class="test_slider_container">
                        <div class="owl-carousel owl-theme test_slider">
                            ...
                            <div class="owl-item">
                                <div class="test_item">
                                    <div class="test_image"><img src="{{asset('asset/images/test_1.jpg')}}"
                            ...
                            <div class="owl-item">
                                <div class="test_item">
                                    <div class="test_image"><img src="{{asset('asset/images/test_2.jpg')}}"
                            ...
                            <div class="owl-item">
                                <div class="test_item">
                                    <div class="test_image"><img src="{{asset('asset/images/test_3.jpg')}}"
    ...
    <div class="trending">
        <div class="container">
            ...
            <div class="row trending_container">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="trending_item clearfix">
                        <div class="trending_image"><img src="{{asset('asset/images/trend_8.png')}}"
