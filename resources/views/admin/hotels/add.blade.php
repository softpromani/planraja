                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="hotel-images" data-bs-toggle="tab"
                                        data-bs-target="#hotelImages" type="button" role="tab"
                                        aria-controls="hotelImages" aria-selected="false">Gallery Management</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="gst-tab" data-bs-toggle="tab" data-bs-target="#gst"
                                        type="button" role="tab" aria-controls="gst" aria-selected="false">GST
                                        information</button>
                                </li>
                            </ul>
                            <?php
                            ...
                            <form name="hotelForm" method="POST" enctype="multipart/form-data"
                                action="{{ url('update-hotel') }}/<?php echo $hotelId; ?>">
                                <?php
                                    } else {
                                        ?>
                                <form name="hotelForm" method="POST" enctype="multipart/form-data"
                                    action="{{ route('save-hotel') }}">
                                    <?php
                                    }
                                ?>
                                    @csrf
                                    ...
                                    <div class="tab-content pt-2" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="basic" role="tabpanel"
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="hotelName"
                                                        value="<?php echo isset($hotelDetail->hotel_name) ? $hotelDetail->hotel_name : ''; ?>">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputEmail" class="col-sm-2 col-form-label">Short
                                                    Description</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="shortDesc"
                                                        value="<?php echo isset($hotelDetail->short_description) ? $hotelDetail->short_description : ''; ?>">
                                                </div>
                                            </div>

                                            <div class="row mb-3">
                                                <label for="inputEmail" class="col-sm-2 col-form-label">Long
                                                    Description</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-select citydata"
                                                        aria-label="Default select example" name="Slect State" required>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-select inputcity"
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputEmail"
                                                    class="col-sm-2 col-form-label">perday_ammount</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="perday_ammount"
                                                        value="">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputEmail" class="col-sm-2 col-form-label">Hotel Email
                                                    Id</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="hotelEmailId"
                                                        value="<?php echo isset($hotelDetail->hotel_email_id) ? $hotelDetail->hotel_email_id : ''; ?>">
                                                </div>
                                            </div>

                                            <div class="row mb-3">
                                                <label for="inputEmail" class="col-sm-2 col-form-label">Hotel Phone
                                                    No</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="hotelPhoneNo"
                                                        value="<?php echo isset($hotelDetail->hotel_phone_no) ? $hotelDetail->hotel_phone_no : ''; ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="address" role="tabpanel"
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="address"
                                                        value="<?php echo isset($hotelDetail->address) ? $hotelDetail->address : ''; ?>">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputEmail" class="col-sm-2 col-form-label">Map
                                                    Location</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="mapLocation"
                                                        value="<?php echo isset($hotelDetail->map_location) ? $hotelDetail->map_location : ''; ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="amenities" role="tabpanel"
                                            ...
                                            <div>
                                                ...
                                                <div class="form-check form-switch"
                                                    style="float:left !important; width:250px !important;">
                                                    <input class="form-check-input" type="checkbox" name="aminitiesArr[]"
                                                        <?php echo in_array($child['id'], $amenityArr) ? 'checked' : ''; ?> value="<?php echo $child['id']; ?>" />
                                        ...
                                        <div class="tab-pane fade" id="hotelImages" role="tabpanel"
                                            aria-labelledby="gallery-tab">
                                            <div class="row mb-3">
                                                <label for="inputNumber" class="col-sm-2 col-form-label">Upload Gallery
                                                    Photo</label>
                                                <div class="col-sm-10">
                                                    <input accept="image/png, image/gif, image/jpeg" class="form-control"
                                                        type="file" id="hotelGallery" name="hotelGallery[]" multiple>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="contact" role="tabpanel"
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="contactPerson"
                                                        value="<?php echo isset($hotelDetail->contact_person) ? $hotelDetail->contact_person : ''; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="mobileNo"
                                                        value="<?php echo isset($hotelDetail->mobile_no) ? $hotelDetail->mobile_no : ''; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="emailId"
                                                        value="<?php echo isset($hotelDetail->email_id) ? $hotelDetail->email_id : ''; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="accountNo"
                                                        value="<?php echo isset($hotelDetail->account_no) ? $hotelDetail->account_no : ''; ?>">
                                                </div>
                                            </div>

                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-2 col-form-label">Account Holder
                                                    Name</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="holderName"
                                                        value="<?php echo isset($hotelDetail->account_holder_name) ? $hotelDetail->account_holder_name : ''; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="ifscCode"
                                                        value="<?php echo isset($hotelDetail->ifsc_code) ? $hotelDetail->ifsc_code : ''; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputNumber" class="col-sm-2 col-form-label">Cancel
                                                    cheque</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="file" id="cancelCheque"
                                                        name="cancelCheque">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="gst" role="tabpanel"
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-2 col-form-label">Hotel GST
                                                    Name</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="gstName"
                                                        value="<?php echo isset($hotelDetail->gst_name) ? $hotelDetail->gst_name : ''; ?>">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="gstNo"
                                                        value="<?php echo isset($hotelDetail->gst_no) ? $hotelDetail->gst_no : ''; ?>">
                                                </div>
                                            </div>

                                            <div class="row mb-3">
                                                <label for="inputNumber" class="col-sm-2 col-form-label">GST
                                                    Certificate</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="file" name="gstPhoto"
                                                        id="gstPhoto">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="gstAddress"
                                                        value="<?php echo isset($hotelDetail->gst_address) ? $hotelDetail->gst_address : ''; ?>">
                                                </div>
                                            </div>

                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-2 col-form-label">Extra
                                                    Charge</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="extraCharge"
                                                        value="<?php echo isset($hotelDetail->extra_charge) ? $hotelDetail->extra_charge : ''; ?>">
                                                </div>
                                            </div>
                                        </div>
