...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('asset/styles/single_listing_styles.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('asset/styles/single_listing_responsive.css')}}">
</head>
