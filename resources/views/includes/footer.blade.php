                ...
                <div class="footer_col">
                    ...
                    <div class="footer_content footer_blog">
                        ...
                        <div class="footer_blog_item clearfix">
                            <div class="footer_blog_image"><img src="{{asset('asset/images/footer_blog_1.jpg')}}" alt="https://unsplash.com/@avidenov"></div>
                        ...
                        <div class="footer_blog_item clearfix">
                            <div class="footer_blog_image"><img src="{{asset('asset/images/footer_blog_2.jpg')}}" alt="https://unsplash.com/@deannaritchie"></div>
                            <div class="footer_blog_content">
                        ...
                        <div class="footer_blog_item clearfix">
                            <div class="footer_blog_image"><img src="{{asset('asset/images/footer_blog_3.jpg')}}" alt="https://unsplash.com/@bergeryap87"></div>
                            <div class="footer_blog_content">
                                <div class="footer_blog_title"><a href="blog.html">Travel with us this year</a>
                                </div>
                                <div class="footer_blog_date">Nov 29, 2017</div>
                    ...
                    <div class="footer_content footer_contact">
                        <ul class="contact_info_list">
                            <li class="contact_info_item d-flex flex-row">
                                <div>
                                    <div class="contact_info_icon"><img src="{{asset('asset/images/placeholder.svg')}}" alt="">
                                    </div>
                                </div>
                            ...
                            <li class="contact_info_item d-flex flex-row">
                                <div>
                                    <div class="contact_info_icon"><img src="{{asset('asset/images/phone-call.svg')}}" alt="">
                                    </div>
                                </div>
                            ...
                            <li class="contact_info_item d-flex flex-row">
                                <div>
                                    <div class="contact_info_icon"><img src="{{asset('asset/images/planet-earth.svg')}}" alt="">
                                    </div>
                                </div>
